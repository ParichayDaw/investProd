    ...
    return (
        <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "auto auto", padding: "30px 0", gap: "16px" }}>
                ...
                <p id={styles.piechart} style={{ fontSize: " x-large", boxShadow: '0 0 10px rgba(0, 0, 0, 0.3)', }}><center><strong>Returns</strong></center><br /><ApexChart plans_data={etta} widthChart={600} /> </p>
            </div>
